...
object HydraQuoSecondTicks extends HydraUseCase(1, 1, "quo") {
  ...
  override val frameSource: String =
    s"""
     ...
     |     cube user.sessions {
     |       dimensions {
     |         'secondTicks':verbatim[long]
     |       }
     |     }
     |   }
     |   user.sessions => {
     |     pre => {
     |       $analysisName.$frameName.'secondTicks' = secondTicks(3)
  ...
  val expected: Array[Any] = Array(3000)
