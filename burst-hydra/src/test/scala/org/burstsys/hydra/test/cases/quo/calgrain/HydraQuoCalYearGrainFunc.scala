...
object HydraQuoCalYearGrainFunc extends HydraUseCase(1, 1, "quo") {
  ...
  override def analysisSource: String =
    s"""
       ...
       |      situ => {
       |        $analysisName.$frameName.grain = yearGrain(user.sessions.events.startTime)
  ...
  val expected: Array[Any] =
    Array((1388563200000L,181173), (1420099200000L,398565))
