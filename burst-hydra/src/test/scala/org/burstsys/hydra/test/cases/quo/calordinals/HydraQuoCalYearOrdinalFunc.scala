...
object HydraQuoCalYearOrdinalFunc extends HydraUseCase(1, 1, "quo") {
  ...
  override def analysisSource: String =
    s"""
       ...
       |      situ ⇒ {
       |        $analysisName.$frameName.grain = yearOrdinal(user.sessions.events.startTime)
  ...
  val expected: Array[Any] =
    Array((2014, 1653420), (2015, 4045191))
