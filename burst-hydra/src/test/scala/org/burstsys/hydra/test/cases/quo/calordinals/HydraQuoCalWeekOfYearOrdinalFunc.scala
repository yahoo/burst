...
object HydraQuoCalWeekOfYearOrdinalFunc extends HydraUseCase(1, 1, "quo") {
  ...
  override def analysisSource: String =
    s"""
       ...
       |      situ => {
       |        $analysisName.$frameName.grain = weekOfYearOrdinal(user.sessions.events.startTime)
  ...
  val expected: Array[Any] =
    Array((1, 1350970), (2, 1338934), (3, 1293933), (4, 554703), (5, 4), (52, 1160067))
