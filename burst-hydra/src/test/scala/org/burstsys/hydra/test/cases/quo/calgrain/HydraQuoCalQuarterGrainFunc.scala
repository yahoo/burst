...
object HydraQuoCalQuarterGrainFunc extends HydraUseCase(1, 1, "quo") {
  ...
  override def analysisSource: String =
    s"""
       ...
       |      situ => {
       |        $analysisName.$frameName.grain = quarterGrain(user.sessions.events.startTime)
  ...
  val expected: Array[Any] =
    Array((1412146800000L,181173), (1420099200000L,398565))
