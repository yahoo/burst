...
object HydraQuoInvertedInlineSetInclusion extends HydraUseCase(1, 1, "quo") {

  //      override lazy val sweep: HydraSweep = new B4A9182E635844415BEC72A01657BBEEB
  ...
  override def analysisSource: String =
    s"""
       ...
       |      pre ⇒ {
       |        if( user.sessions.events.eventId not in (6049337, 4498119) ) {
