...
import org.burstsys.hydra.test.cases.quo.timegrain.HydraQuoMinuteGrainFunc.{assertLimits, equal}
import org.burstsys.hydra.test.cases.support.HydraUseCase

/**
  * takes too long
  */
object HydraQuoSecondGrain extends HydraUseCase(1, 1, "quo") {
