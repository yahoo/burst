...
import org.burstsys.fabric.wave.data.model.slice.metadata.{FabricSliceMetadata, FabricSliceMetadataContext}
...
/**
 * All information related to the ''generation'' of a [[org.burstsys.fabric.wave.metadata.model.view.FabricView]]
