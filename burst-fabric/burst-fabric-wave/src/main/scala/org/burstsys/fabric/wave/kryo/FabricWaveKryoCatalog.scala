...
package org.burstsys.fabric.wave.kryo
...
import org.burstsys.fabric.wave.data.model.generation.metrics.FabricGenerationMetricsContext
import org.burstsys.fabric.wave.data.model.mode.{FabricColdLoad, FabricHotLoad, FabricUnknownLoad, FabricWarmLoad}
import org.burstsys.fabric.wave.data.model.ops._
import org.burstsys.fabric.wave.data.model.slice.data._
import org.burstsys.fabric.wave.data.model.slice.metadata.FabricSliceMetadataContext
import org.burstsys.fabric.wave.data.model.slice.state._
import org.burstsys.fabric.wave.data.model.snap._
import org.burstsys.fabric.wave.execution.model.execute.group.FabricGroupKeyContext
import org.burstsys.fabric.wave.execution.model.execute.invoke._
import org.burstsys.fabric.wave.execution.model.execute.parameters._
import org.burstsys.fabric.wave.execution.model.gather.control.FabricFaultGatherContext
import org.burstsys.fabric.wave.execution.model.gather.data.{FabricEmptyGatherContext, MockDataGather}
import org.burstsys.fabric.wave.execution.model.gather.metrics.FabricGatherMetricsContext
import org.burstsys.fabric.wave.execution.model.metrics.FabricExecutionMetricsContext
import org.burstsys.fabric.wave.execution.model.result.FabricExecuteResultContext
...
import org.burstsys.fabric.wave.execution.model.wave.{FabricParticleContext, FabricWaveContext}
import org.burstsys.fabric.wave.metadata.model.datasource.FabricDatasourceContext
import org.burstsys.fabric.wave.metadata.model.domain.FabricDomainContext
import org.burstsys.fabric.wave.metadata.model.view.FabricViewContext
 ...
 */
@unused
class FabricWaveKryoCatalog extends VitalsKryoCatalogProvider {

  val key = new AtomicInteger(waveCatalogStart)
