...
import org.burstsys.fabric.wave.execution.model.gather.metrics.{FabricGatherMetrics, FabricGatherMetricsContext, FabricOutcome}
 ...
 * as part of a [[FabricWave]] / [[org.burstsys.fabric.wave.execution.model.wave.FabricParticle]]
 * scatter/gather
 * <p/>
 * They come in two basic subtypes [[org.burstsys.fabric.wave.execution.model.gather.control.FabricControlGather]]
 * and [[org.burstsys.fabric.wave.execution.model.gather.data.FabricDataGather]] depending if they represent
