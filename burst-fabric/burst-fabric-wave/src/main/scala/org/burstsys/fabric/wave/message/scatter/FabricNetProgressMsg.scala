...
package org.burstsys.fabric.wave.message.scatter

import com.esotericsoftware.kryo.Kryo
import com.esotericsoftware.kryo.io.{Input, Output}
import org.burstsys.fabric.wave.message.FabricNetProgressMsgType
...
object FabricNetProgressMsg {
  ...
  def apply(buffer: Array[Byte]): FabricNetProgressMsg = {
