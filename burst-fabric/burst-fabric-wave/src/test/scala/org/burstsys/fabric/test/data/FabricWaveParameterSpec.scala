...
import org.burstsys.fabric.wave.execution.model.execute.parameters.{FabricCall, FabricParameterType, FabricParameterValue, FabricSignature}
...
class FabricWaveParameterSpec extends FabricWaveSupervisorWorkerBaseSpec {
