...
import org.burstsys.fabric.data.worker.cache.{FabricSnapCacheListener, burstModuleName => _}
...
class FabricCacheResliceSpec extends FabricCacheLifecycleSpec with FabricSnapCacheListener {
