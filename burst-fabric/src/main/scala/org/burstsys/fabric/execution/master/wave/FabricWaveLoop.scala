...
import org.burstsys.fabric.execution.master.wave.request.FabricParticleRequest
    ...
    TeslaRequestFuture {
      ...
      while (gather == null) {
        ...
        update match {
          ...
          // Either way it has the a merged master and if applicable worker side stack information merged together
