...
package org.burstsys.fabric.execution.master.group
...
import org.burstsys.fabric.execution.master.wave.FabricWaveExecute
...
abstract
class FabricGroupExecuteContext extends FabricMasterService with FabricGroupExecutor with FabricWaveExecute {
