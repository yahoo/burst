...
package org.burstsys.fabric.data.model.snap
...
trait FabricSnap extends AnyRef {
  ...
  /**
   * @return value obtained from [[org.burstsys.fabric.metadata.ViewCacheEvictTtlMsProperty]] or
   * [[org.burstsys.fabric.configuration.burstViewCacheEvictTtlMsPropertyDefault]]
   */
  def evictTtlMs: Long

  /**
   * @return value obtained from [[org.burstsys.fabric.metadata.ViewCacheFlushTtlMsProperty]] or
   * [[org.burstsys.fabric.configuration.burstViewCacheFlushTtlMsPropertyDefault]]
   */
  def flushTtlMs: Long

  /**
   * @return value obtained from [[org.burstsys.fabric.metadata.ViewCacheEraseTtlMsProperty]] or
   * [[org.burstsys.fabric.configuration.burstViewCacheEraseTtlMsPropertyDefault]]
   */
  def eraseTtlMs: Long
