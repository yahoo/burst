...
trait FabricNetLink extends Any {
  ...
  /**
    ...
    */
  final def isConnected: Boolean = channel != null && channel.isRegistered && channel.isActive
  ...
  /**
    ...
    */
  final
  def link: String = s"local=$localAddress:$localPort, remote=$remoteAddress:$remotePort"
