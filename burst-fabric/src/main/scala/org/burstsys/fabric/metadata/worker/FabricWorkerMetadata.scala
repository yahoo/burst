...
package org.burstsys.fabric.metadata.worker
...
object FabricWorkerMetadata {
  ...
  def apply(container: FabricWorkerContainer, modality: VitalsServiceModality = VitalsStandardServer): FabricWorkerMetadata =
    FabricWorkerMetadataContext(container: FabricWorkerContainer, modality: VitalsServiceModality)

}

private final case
class FabricWorkerMetadataContext(container: FabricWorkerContainer, modality: VitalsServiceModality)
