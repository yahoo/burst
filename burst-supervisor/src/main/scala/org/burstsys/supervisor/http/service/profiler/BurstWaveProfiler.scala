...
package org.burstsys.supervisor.http.service.profiler

import java.util.concurrent.atomic.AtomicBoolean
import org.burstsys.agent.AgentService
import org.burstsys.catalog.CatalogService
import org.burstsys.supervisor.http.service.provider.profiler._
...
import org.burstsys.supervisor.http.service.provider.ProfilerRunResponse
import org.burstsys.supervisor.http.service.provider.ProfilerStopResponse
...
case class BurstWaveProfiler(agent: AgentService, catalog: CatalogService) extends BurstWaveSupervisorProfilerService {
  ...
  private val listeners = new ArrayBuffer[BurstWaveProfilerListener]
  ...
  override def talksTo(listener: BurstWaveProfilerListener): Unit = listeners += listener
