...
final class WaveSupervisorTorcherEndpoint extends WaveSupervisorEndpoint {

  private val CSV_COLUMNS: String = Array(
    "DomainId",
    "ProjectId + Moniker",
  ...
  def getColdLoadStatsTable: String = {
    resultOrErrorResponse {
      ...
      val csvTable: ArrayBuffer[String] = mutable.ArrayBuffer[String](CSV_COLUMNS)
