...
package org.burstsys.supervisor.torcher
...
import org.burstsys.supervisor.http.service.provider.TorcherDatasetStatistics
...
import org.burstsys.supervisor.http.service.provider.TorcherSummaryStats
 ...
 */
trait BurstSupervisorTorcherService extends BurstWaveSupervisorTorcherService

object BurstSupervisorTorcherService {
  def apply(agent: AgentService, catalog: CatalogService): BurstSupervisorTorcherService = BurstSupervisorTorcherProvider(agent, catalog)
}

private[torcher] final case
class BurstSupervisorTorcherProvider(agent: AgentService, catalog: CatalogService) extends BurstSupervisorTorcherService {
