...
trait BurstSupervisorContainer extends FabricSupervisorContainer {
...
class BurstSupervisorContainerContext() extends FabricSupervisorContainerContext(defaultFabricNetworkServerConfig)
  with BurstSupervisorContainer with BurstSupervisorStartup {
