...
import org.burstsys.felt.model.mutables.valarr.FeltMutableValArrBuilder
import org.burstsys.tesla.TeslaTypes.TeslaMemorySize
import org.burstsys.tesla.part.TeslaPartBuilder

/**
 * parameters for building a zap val array
 */
final case
class ZapValArrayBuilder(
                          var name: String = "no_name",
                          var defaultStartSize: TeslaMemorySize = flex.defaultStartSize
                        ) extends FeltMutableValArrBuilder with KryoSerializable {
