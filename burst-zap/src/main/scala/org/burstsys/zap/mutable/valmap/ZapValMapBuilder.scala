...
import org.burstsys.felt.model.mutables.valmap.FeltMutableValMapBuilder
import org.burstsys.tesla.TeslaTypes.TeslaMemorySize
import org.burstsys.tesla.part.TeslaPartBuilder

/**
 * parameters for building a zap val map
 */
final case
class ZapValMapBuilder(
                        var name: String = "no_name",
                        var defaultStartSize: TeslaMemorySize = flex.defaultStartSize
                      ) extends FeltMutableValMapBuilder  with KryoSerializable {
