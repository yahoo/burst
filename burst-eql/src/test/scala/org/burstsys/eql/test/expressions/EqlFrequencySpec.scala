...
class EqlFrequencySpec extends EqlAlloyTestRunner {
  ...
  it should "successfully do frequency with additional split grouping" in {
    ...
    runTest(source, 200, 200, { result =>
      ...
      r should contain theSameElementsAs Array(
        (4, 0, 1), (7, 0, 1), (2, 0, 1), (5, 0, 1), (0, 0, 1), (3, 0, 1), (6, 0, 1), (1, 0, 1), (8, 0, 2), (9, 0, 2),
        (8, 3, 15), (9, 3, 15), (1, 3, 16), (7, 3, 16), (0, 3, 16), (4, 3, 17), (2, 3, 17), (5, 3, 17), (3, 3, 17), (6, 3, 17)
      )
    })
  }
  ...
  it should "successfully do frequency with additional enum grouping" in {
    ...
    runTest(source, 200, 200, { result =>
      ...
      r should contain theSameElementsAs Array(
        ...
        (3,1000,16), (9,1000,16), (1,1000,16), (4,1000,16), (7,1000,16), (2,1000,16), (8,1000,16), (6,1000,17), (5,1000,17)
      )
    })
  }
}
