...
/**
 * A type declaration for an ''array'' of primitive value types
 *
 * @see [[FeltMutableValArr]]
 */
trait FeltArrayTypeDecl extends FeltTypeDecl {

  final override val nodeName = "felt-array-type-decl"
  ...
  def resolveTypes: this.type = {
    feltType = FeltType.valArray(valueType)
    this
  }
  ...
  def normalizedSource(implicit index: Int): String =
    s"arry[${brioDataTypeNameFromKey(valueType).toLowerCase}]"
