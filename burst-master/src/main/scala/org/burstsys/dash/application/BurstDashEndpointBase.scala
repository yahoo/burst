...
import org.burstsys.fabric.container.masterContainer
...
abstract class BurstDashEndpointBase {
  ...
  final var container: BurstMasterContainer = masterContainer.asInstanceOf[BurstMasterContainer]
  ...
  @Inject
  var master: FabricMasterContainer = _
