...
public final class ParseReferenceScalar extends ParseReference {

    public ParseReferenceScalar(NodeGlobal global, NodeLocation location, Integer number, String name,
                                ArrayList<ParseClassifier> classifiers, String referenceTypeName) {
        super(global, location, NodeType.SCHEMA_PARSE_REFERENCE_SCALAR, number, name, RelationType.REFERENCE_SCALAR, classifiers,
                referenceTypeName);
    }
