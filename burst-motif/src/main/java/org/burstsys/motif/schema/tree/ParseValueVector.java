...
public final class ParseValueVector extends ParseValue {

    public ParseValueVector(NodeGlobal global, NodeLocation location, Integer number, String name,
                            ArrayList<ParseClassifier> classifiers, Node valueDataType) {
        super(global, location, NodeType.SCHEMA_PARSE_VALUE_VECTOR, number, name, RelationType.VALUE_VECTOR,
                classifiers, valueDataType);
    }
