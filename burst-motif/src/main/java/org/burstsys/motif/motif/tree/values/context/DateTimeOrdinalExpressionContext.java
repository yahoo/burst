...
import org.burstsys.motif.motif.tree.values.DateTimeOrdinalExpression;
...
public final class DateTimeOrdinalExpressionContext extends TimezonedExpressionContext implements DateTimeOrdinalExpression {
    ...
    @JsonProperty
    private DateTimeOrdinalOperatorType op;

    @SuppressWarnings("unused")
    public DateTimeOrdinalExpressionContext() {
        super(NodeGlobal.defaultNodeGlobal(), NodeType.TIME_VALUE, null);
    }

    public DateTimeOrdinalExpressionContext(NodeGlobal global, NodeLocation location, ValueExpression expr, DateTimeOrdinalOperatorType op, ValueExpression timezone) {
        super(global, location, NodeType.TIME_VALUE, timezone);
        this.op = op;
        this.expr = expr;
    }
    ...
    @Override
    public DateTimeOrdinalOperatorType getOp() {
        return op;
    }
