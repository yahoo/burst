...
trait SampleSourceMasterService extends VitalsService {
  ...
  /**
   * @return The name of this sample source master. Should probably match the name in the [[SampleSourceService]]
   */
  def name: String
