...
package object trek {
  ...
  private[samplestore] val ITEM_COUNT_KEY = AttributeKey.longKey("burstsys.itemCount")
  ...
  private[samplestore] val EXPECTED_ITEM_COUNT_KEY = AttributeKey.longKey("burstsys.expectedItemCount")
